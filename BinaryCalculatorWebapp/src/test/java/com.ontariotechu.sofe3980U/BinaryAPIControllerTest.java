...
public class BinaryAPIControllerTest {
    ...
    public void multiply() throws Exception {
        this.mvc.perform(get("/multiply").param("operand1","111").param("operand2","101"))//.andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string("100011"));
    }
    @Test
    public void and() throws Exception {
        this.mvc.perform(get("/and").param("operand1","1001").param("operand2","0110"))//.andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string("0000"));
    }
    @Test
    public void or() throws Exception {
        this.mvc.perform(get("/or").param("operand1","1010").param("operand2","0101"))//.andDo(print())
                .andExpect(status().isOk())
